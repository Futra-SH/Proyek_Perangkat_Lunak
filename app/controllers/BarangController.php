...
class BarangController extends SecureController
{
	...
	function view($rec_id = null, $value = null)
	{
		...
		$db->join("ruang", "barang.Id_Ruangan = ruang.Id_Ruangan", "INNER");
		$db->join("kondisi", "barang.Id_Kondisi = kondisi.Id_Kondisi", "INNER");
	...
	function add($formdata = null)
	{
		if ($formdata) {
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Kode_Barang", "Nama_Barang", "Merek", "Id_Kondisi", "Jumlah_Aset", "Asal_Perolehan", "Id_Ruangan", "Gambar_Barang", "Tahun_Perolehan");
			...
			$this->rules_array = array(
				...
				'Tahun_Perolehan' => 'required', "barang.Id_Kategori",
			);
	...
	function edit($rec_id = null, $formdata = null)
	{
		...
		$tablename = $this->tablename;
		//editable fields
		$fields = $this->fields = array("Id_Barang", "Kode_Barang", "Nama_Barang", "Merek", "Id_Kondisi", "Jumlah_Aset", "Asal_Perolehan", "Id_Ruangan", "Gambar_Barang", "Tahun_Perolehan");
		if ($formdata) {
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Kode_Barang' => 'required',
