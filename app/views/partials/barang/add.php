                        ...
                        <form id="barang-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("barang/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Nama_Barang">Kode Barang <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Id_Kondisi">Kondisi <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required="" id="ctrl-Id_Kondisi" name="Id_Kondisi" placeholder="Select a value ..." class="custom-select">
                                                    ...
                                                    if (!empty($Id_Kondisi_options)) {
                                                        foreach ($Id_Kondisi_options as $option) {
                                                            ...
                                                            $selected = $this->set_field_selected('Id_Kondisi', $value, "");
                                                    ?>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Jumlah_Aset" value="<?php echo $this->set_field_value('Jumlah_Aset', ""); ?>" type="number" placeholder="Enter Jumlah Aset" step="1" required="" name="Jumlah_Aset" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Asal_Perolehan">Keterangan <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Asal_Perolehan" value="<?php echo $this->set_field_value('Asal_Perolehan', ""); ?>" type="text" placeholder="Enter Asal Perolehan" required="" name="Asal_Perolehan" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Id_Ruangan">Ruangan <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required="" id="ctrl-Id_Ruangan" name="Id_Ruangan" placeholder="Select a value ..." class="custom-select">
                                                    ...
                                                    if (!empty($Id_Ruangan_options)) {
                                                        foreach ($Id_Ruangan_options as $option) {
                                                            $value = (!empty($option['value']) ? $option['value'] : null);
                                                            $label = (!empty($option['label']) ? $option['label'] : $value);
                                                            $selected = $this->set_field_selected('Id_Ruangan', $value, "");
                                                    ?>
                                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                                <?php echo $label; ?>
                                                            </option>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <div class="dropzone required" input="#ctrl-Gambar_Barang" fieldname="Gambar_Barang" data-multiple="false" dropmsg="Choose files or drag and drop files to upload" btntext="Browse" filesize="3" maximum="1">
                                                    <input name="Gambar_Barang" id="ctrl-Gambar_Barang" required="" class="dropzone-input form-control" value="<?php echo $this->set_field_value('Gambar_Barang', ""); ?>" type="text" />
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Tahun_Perolehan">Waktu Perolehan <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Tahun_Perolehan" value="<?php echo $this->set_field_value('Tahun_Perolehan', ""); ?>" type="number" placeholder="Enter Tahun Perolehan" step="1" required="" name="Tahun_Perolehan" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
