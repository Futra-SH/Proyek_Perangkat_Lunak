                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="td-role_id">
                                                        <span <?php if ($can_edit) { ?> data-value="<?php echo $data['role_id']; ?>" data-pk="<?php echo $data['permission_id'] ?>" data-url="<?php print_link("role_permissions/editfield/" . urlencode($data['permission_id'])); ?>" data-name="role_id" data-title="Enter Role Id" data-placement="left" data-toggle="click" data-type="number" data-mode="popover" data-showbuttons="left" class="is-editable" <?php } ?>>
                                                            <?php echo $data['role_id']; ?>
                                                        </span>
                                                    </td>
                                                    <td class="td-page_name">
                                                        <span <?php if ($can_edit) { ?> data-value="<?php echo $data['page_name']; ?>" data-pk="<?php echo $data['permission_id'] ?>" data-url="<?php print_link("role_permissions/editfield/" . urlencode($data['permission_id'])); ?>" data-name="page_name" data-title="Enter Page Name" data-placement="left" data-toggle="click" data-type="text" data-mode="popover" data-showbuttons="left" class="is-editable" <?php } ?>>
                                                            <?php echo $data['page_name']; ?>
                                                        </span>
                                                    </td>
                                                    <td class="td-action_name">
                                                        <span <?php if ($can_edit) { ?> data-value="<?php echo $data['action_name']; ?>" data-pk="<?php echo $data['permission_id'] ?>" data-url="<?php print_link("role_permissions/editfield/" . urlencode($data['permission_id'])); ?>" data-name="action_name" data-title="Enter Action Name" data-placement="left" data-toggle="click" data-type="text" data-mode="popover" data-showbuttons="left" class="is-editable" <?php } ?>>
