                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="td-role_name">
                                                        <span <?php if ($can_edit) { ?> data-value="<?php echo $data['role_name']; ?>" data-pk="<?php echo $data['role_id'] ?>" data-url="<?php print_link("roles/editfield/" . urlencode($data['role_id'])); ?>" data-name="role_name" data-title="Enter Role Name" data-placement="left" data-toggle="click" data-type="text" data-mode="popover" data-showbuttons="left" class="is-editable" <?php } ?>>
